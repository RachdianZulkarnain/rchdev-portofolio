...
import { BackgroundGridAnimated } from "@/components/backgrounds";
        ...
        {Object.entries(TECH_STACK).map(([category, techs]) => (
          <div key={category} className="space-y-3">
            ...
            <div className="relative flex items-center justify-center">
              <div className="via-primary/40 h-px flex-1 bg-linier-to-r from-transparent to-transparent" />
              <span className="text-muted-foreground px-2 text-xs font-medium tracking-widest uppercase">
                {category}
              </span>
              <div className="via-primary/40 h-px flex-1 bg-linierfg-to-r from-transparent to-transparent" />
            </div>

            {/* Marquee */}
            <div className="relative overflow-hidden rounded-xl border border-dashed">
              <div className="from-card pointer-events-none absolute inset-y-0 left-0 w-10 bg-linier-to-r via-transparent to-transparent" />
              <div className="from-card pointer-events-none absolute inset-y-0 right-0 w-10 bg-linier-to-l via-transparent to-transparent" />
  ...
  const activityMetrics = [
    {
      ...
      color: "#22c55e",
      breakdown: `${data?.pullRequests.merged ?? 0} merged, ${
...
export default function Stats() {
  ...
  return (
    <SectionHeading className="px-4 py-12 md:px-8" id="statsistics" text="Stats">
      <div aria-hidden className="pointer-events-none absolute inset-0 -z-10">
        <div className="absolute inset-0 bg-[linear-gradient(to_right,rgba(0,0,0,.06)_1px,transparent_1px),linear-gradient(to_bottom,rgba(0,0,0,.06)_1px,transparent_1px)] [mask:linear-gradient(to_bottom,black,transparent_85%)] bg size:18px_18px dark:bg-[linear-gradient(to_right,rgba(255,255,255,.06)_1px,transparent_1px),linear-gradient(to_bottom,rgba(255,255,255,.06)_1px,transparent_1px)]" />
      </div>
