...
const Navbar = () => {
  ...
  const updateClip = () => {
    ...
    container.style.clipPath = `inset(0 ${rightPct.toFixed(
      2
    )}% 0 ${leftPct.toFixed(2)}% round 17px)`;
  };
            ...
            >
              {NAV_LINKS.map((x, index) => (
                ...
                >
                  ...
                  <div className=" absolute inset-0 -translate-x-full bg-linear-gradient-to-r from-foreground/0 via-foreground/5 to-foreground/0 transition-transform duration-700 ease-in-outgroup-hover:translate-x-full" />
