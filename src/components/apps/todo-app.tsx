      ...
      <>
        ...
        >
          <Button
            variant="ghost"
            size="icon"
            className="h-6 w-6 rounded-full p-0 mt-0.5 shrink-0"
          ...
          <div className="flex-1 min-w-0 ml-3">
            <div className="flex items-center justify-between">
              {isEditTask ? (
                ...
                <span
                  className={cn(
                    "text-sm font-medium wrap-break-words transition-all duration-200",
                    todo.completed &&
              ...
              <div className="flex justify-end gap-2">
                <Button
                  ...
                  className="h-6 w-6 rounded-full p-0 opacity-0 group-hover:opacity-100 transition-opacity shrink-0"
