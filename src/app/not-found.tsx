...
import { BackgroundNoise } from "@/components/backgrounds";
  ...
  return (
    ...
    >
      <div className="group relative h-35 w-full overflow-hidden">
        <div className="from-muted/30 absolute inset-0 bg-linear-to-t to-transparent opacity-0 transition-opacity duration-300 group-hover:opacity-100" />
